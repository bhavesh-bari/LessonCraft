                    ...
                    <form onSubmit={handleGeneratePaper} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input id="subject" type="text" value={subject} onChange={(e) => setSubject(e.target.value)} placeholder="e.g., Data Structures" className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500" />
                                </div>
                            </div>
                            {/* Total Marks */}
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input id="totalMarks" type="number" value={totalMarks} onChange={(e) => setTotalMarks(e.target.value)} placeholder="e.g., 70" className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500" />
                                </div>
                            </div>
                            {/* Duration */}
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input id="duration" type="text" value={duration} onChange={(e) => setDuration(e.target.value)} placeholder="e.g., 3 Hours" className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <textarea id="syllabus" value={syllabus} onChange={(e) => setSyllabus(e.target.value)} rows="4" placeholder="Enter the syllabus or key topics..." className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></textarea>
                            </div>
                        </div>
                                ...
                                {questions.map((q, index) => (
                                    <div key={index} className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <input type="text" value={q.text} onChange={(e) => handleQuestionChange(index, 'text', e.target.value)} placeholder="Enter question text or instruction" className="flex-grow p-2 border rounded-md" />
                                            <input type="number" value={q.marks} onChange={(e) => handleQuestionChange(index, 'marks', e.target.value)} placeholder="Marks" className="w-20 p-2 border rounded-md" />
                ...
                {paper && (
                    <section className="bg-white p-8 rounded-2xl shadow-lg">
                        <div className="flex justify-between items-center mb-6 border-b pb-4">
                            ...
                            <button onClick={() => alert('Downloading PDF...')} className="flex items-center gap-2 bg-red-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-red-700">
                                <Download size={18} /> Download as PDF
                            </button>
                        </div>

                        <div className="border p-6 rounded-md font-serif">
                            {/* Paper Header */}
                                ...
                                {paper.questions.map((q, index) => (
                                    <div key={index}>
                                        <div className="flex justify-between items-start">
                                            <p className="pr-4"><strong>Q{q.q_num}.</strong> {q.text}</p>
                                            <span className="font-bold whitespace-nowrap">[{q.marks} Marks]</span>
                                        </div>
                                        {q.sub_questions && (
                                            <div className="pl-8 mt-2 space-y-2">
                                                {q.sub_questions.map((sub, sub_index) => (
                                                    <div key={sub_index} className="flex justify-between items-start">
                                                        <p className="pr-4">{sub.is_or && <span className="font-bold mr-2">OR</span>}<strong>({sub.q_num})</strong> {sub.text}</p>
                                                        <span className="font-bold whitespace-nowrap">[{sub.marks} Marks]</span>
                                                    </div>
                                                ))}
                                            </div>
                                        )}
