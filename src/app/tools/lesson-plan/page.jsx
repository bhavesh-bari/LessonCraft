// You would place this file at a route like: src/app/tools/lesson-plan/page.js
        ...
        <main className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8 font-sans">
            <div className="max-w-5xl mx-auto">
                ...
                <header className="flex items-center gap-4 mb-8">
                    <NotebookPen className="w-12 h-12 text-indigo-600" />
                    <div>
                    ...
                    <form onSubmit={handleGeneratePlan} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input id="subject" type="text" value={subject} onChange={(e) => setSubject(e.target.value)} placeholder="e.g., General Science" className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <NotebookPen className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
                                <input id="topic" type="text" value={topic} onChange={(e) => setTopic(e.target.value)} placeholder="e.g., The Water Cycle" className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select id="grade" value={grade} onChange={(e) => setGrade(e.target.value)} className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input id="duration" type="text" value={duration} onChange={(e) => setDuration(e.target.value)} placeholder="e.g., 45 minutes" className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500" />
                            </div>
                        </div>

                        {/* Key Points */}
                        <div className="md:col-span-2">
                            <label htmlFor="keyPoints" className="block text-sm font-medium text-gray-700 mb-1">Key Points (Optional)</label>
                            <div className="relative">
                                <List className="absolute left-3 top-3 w-5 h-5 text-gray-400" />
                                <textarea id="keyPoints" value={keyPoints} onChange={(e) => setKeyPoints(e.target.value)} rows="3" placeholder="Enter any key points to focus on..." className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"></textarea>
                            </div>
                        </div>

                        {/* Generate Button */}
                        <div className="md:col-span-2">
                            <button type="submit" disabled={isLoading} className="w-full flex items-center justify-center gap-3 bg-indigo-600 text-white font-bold py-3 px-6 rounded-lg text-lg hover:bg-indigo-700 active:scale-95 transition-all shadow-md disabled:bg-indigo-300">
                ...
                {lessonPlan && (
                    <div className="bg-white p-8 rounded-2xl shadow-lg">
                        ...
                        <div className="space-y-6">
                            {/* Introduction */}
                            <div>
                                <h3 className="flex items-center gap-2 text-xl font-semibold text-gray-700 mb-2"><LayoutList className="text-indigo-500" /> Introduction</h3>
